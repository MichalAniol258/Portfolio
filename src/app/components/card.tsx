...
export default function Card({
    ...
    return (
        <div className="relative p-[3px] rounded-2xl bg-gradient-to-br from-yellow-200 to-blue-200 max-w-xs w-full z-1 opacity-85 group">
            <div className="bg-gray-950 rounded-2xl shadow-md overflow-hidden">
                ...
                <div className="absolute top-2 flex justify-center p-2 text-center w-full gap-3  opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-1">
                    {lg.map((tech, index) => (
                        <p key={index} className="bg-gray-950 text-blue-200 p-2 rounded-xs">{tech}</p>
                    )
                    )}
                ...
                <div className="p-6 flex flex-col justify-between h-[225px]">
                    ...
                    <button className="mt-4 inline-block px-4 py-2 bg-yellow-200 text-gray-950 text-sm font-medium rounded-lg cursor-pointer hover:bg-blue-200 transition-colors">
